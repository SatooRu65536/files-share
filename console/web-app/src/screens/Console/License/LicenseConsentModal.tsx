...
const LicenseConsentModal = () => {
  ...
  const [displayForceAcknowledge, setDisplayForceAcknowledge] = useState<boolean>(false);
  const [acknowledgeDisabled, setAcknowledgeDisabled] = useState<boolean>(false);

  const licenseAcknowledged = useSelector((state: AppState) => state.system.licenseAcknowledged);
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              By using this software, you acknowledge that MinIO software is licensed under the <LicenseLink />, for
              which, the full text can be found here:{' '}
              <a href={`https://www.gnu.org/licenses/agpl-3.0.html`} rel="noopener" className={'link-text'}>
            ...
            >
              Please review the terms carefully and ensure you are in compliance with the obligations of the license. If
              you are not able to satisfy the license obligations, we offer a commercial license which is available
              here:{' '}
              <a href={`https://min.io/signup?ref=con`} rel="noopener" className={'link-text'}>
                https://min.io/signup.
              </a>
            </Box>
            <LicenseFAQ />
