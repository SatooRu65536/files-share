...
export const IAM_SCOPES = {
  ...
  S3_PUT_BUCKET_OBJECT_LOCK_CONFIGURATION: 's3:PutBucketObjectLockConfiguration',
...
export const IAM_PAGES = {
  ...
  IDP_OPENID_CONFIGURATIONS_VIEW: '/identity/idp/openid/configurations/:idpName',
...
const IAM_PERMISSIONS = {
  ...
  [IAM_ROLES.BUCKET_VIEWER]: [IAM_SCOPES.S3_LIST_BUCKET, IAM_SCOPES.S3_ALL_LIST_BUCKET],
...
export const IAM_PAGES_PERMISSIONS = {
  ...
  [IAM_PAGES.EVENT_DESTINATIONS_ADD_SERVICE]: [IAM_SCOPES.ADMIN_SERVER_INFO, IAM_SCOPES.ADMIN_CONFIG_UPDATE],
  [IAM_PAGES.EVENT_DESTINATIONS_ADD]: [IAM_SCOPES.ADMIN_SERVER_INFO, IAM_SCOPES.ADMIN_CONFIG_UPDATE],
  ...
  [IAM_PAGES.LICENSE]: [IAM_SCOPES.ADMIN_SERVER_INFO, IAM_SCOPES.ADMIN_CONFIG_UPDATE],
  ...
  [IAM_PAGES.KMS_KEYS_ADD]: [IAM_SCOPES.KMS_LIST_KEYS, IAM_SCOPES.KMS_CREATE_KEY],
  [IAM_PAGES.KMS_KEYS_IMPORT]: [IAM_SCOPES.KMS_LIST_KEYS, IAM_SCOPES.KMS_IMPORT_KEY],
  [IAM_PAGES.IDP_LDAP_CONFIGURATIONS]: [IAM_SCOPES.ADMIN_ALL_ACTIONS, IAM_SCOPES.ADMIN_CONFIG_UPDATE],
  [IAM_PAGES.IDP_OPENID_CONFIGURATIONS]: [IAM_SCOPES.ADMIN_ALL_ACTIONS, IAM_SCOPES.ADMIN_CONFIG_UPDATE],
  [IAM_PAGES.IDP_OPENID_CONFIGURATIONS_ADD]: [IAM_SCOPES.ADMIN_ALL_ACTIONS, IAM_SCOPES.ADMIN_CONFIG_UPDATE],
  [IAM_PAGES.IDP_OPENID_CONFIGURATIONS_VIEW]: [IAM_SCOPES.ADMIN_ALL_ACTIONS, IAM_SCOPES.ADMIN_CONFIG_UPDATE],
};
