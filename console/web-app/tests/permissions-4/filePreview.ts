...
export const file = Selector('.ReactVirtualized__Table__rowColumn').withText('internode.png');
...
test
  .before(async (t) => {
    ...
    await functions.uploadNamedObjectToBucket(t, bucketName, 'internode.png', 'web-app/tests/uploads/internode.png');
