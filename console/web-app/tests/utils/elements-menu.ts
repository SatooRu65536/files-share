...
export const usersElement = identityChildren.find('button').withAttribute('id', 'users');
export const groupsElement = identityChildren.find('button').withAttribute('id', 'groups');
...
export const dashboardElement = monitoringChildren.find('button').withAttribute('id', 'monitorMetrics');
export const logsElement = monitoringChildren.find('button').withAttribute('id', 'monitorLogs');
export const traceElement = monitoringChildren.find('button').withAttribute('id', 'monitorTrace');
export const drivesElement = monitoringChildren.find('button').withAttribute('id', 'monitorDrives');
